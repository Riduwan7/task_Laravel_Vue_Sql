            ...
            <tbody>
                ...
                <tr v-for="p in projects">
                    ...
                    <td>
                        ...
                        <span v-if="p.status=='pending'" class="badge bg-warning">
                            Pending
                        </span>

                        <span v-if="p.status=='in_progress'" class="badge bg-primary">
                            In Progress
                        </span>

                        <span v-if="p.status=='completed'" class="badge bg-success">
                            Completed
                        </span>
